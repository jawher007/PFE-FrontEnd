...
import { TreeItemFilterWrapper } from './drag-and-drop/models/tree-filter-item-wrapper';
 ...
 */
export declare const filterTree: (items: TreeItemFilterWrapper[], term: string, { operator, ignoreCase }: TreeViewFilterSettings, textField: string | string[], depth?: number) => TreeItemFilterWrapper[];
