...
var filterTree = function (items, term, _a, textField, depth) {
    var operator = _a.operator, ignoreCase = _a.ignoreCase;
    if (depth === void 0) { depth = 0; }
    var field = typeof textField === "string" ? textField : textField[depth];
    return items.reduce(function (acc, wrapper) {
        ...
        if (matcher(wrapper.dataItem, term)) {
            ...
            var newItems = filterTree(wrapper.children, term, { operator: operator, ignoreCase: ignoreCase }, textField, depth + 1);
...
var ɵ0 = function (a, b) { return a.indexOf(b) >= 0; }, ɵ1 = function (a, b) { return a.indexOf(b) === -1; }, ɵ2 = function (a, b) { return a.lastIndexOf(b, 0) === 0; }, ɵ3 = function (a, b) { return a.lastIndexOf(b, 0) === -1; }, ɵ4 = function (a, b) { return a.indexOf(b, a.length - b.length) >= 0; }, ɵ5 = function (a, b) { return a.indexOf(b, a.length - b.length) < 0; };
var operators = {
    contains: ɵ0,
    doesnotcontain: ɵ1,
    startswith: ɵ2,
...
var matchByFieldAndCase = function (field, operator, ignoreCase) { return function (dataItem, term) { return matchByCase(operators[operator], ignoreCase)(dataItem[field], term); }; };
 ...
 * @hidden
 */
var defaultTreeviewFilterSettings = { operator: 'contains', ignoreCase: true };
...
var mapToWrappers = function (currentLevelNodes, childrenField) {
...
var HierarchyBindingDirective = /** @class */ (function () {
    function HierarchyBindingDirective(treeView, dragAndDropDirective) {
        var _this = this;
        this.treeView = treeView;
        ...
        var shouldFilter = !isPresent(this.dragAndDropDirective);
        this.treeView.isVisible = shouldFilter ? function (node) { return _this.visibleNodes.has(node); } : isVisible;
    }
    ...
    Object.defineProperty(HierarchyBindingDirective.prototype, "filter", {
        /**
    ...
    Object.defineProperty(HierarchyBindingDirective.prototype, "filterSettings", {
        get: function () {
         ...
         */
        set: function (value) {
            this._filterSettings = __assign({}, defaultTreeviewFilterSettings, value);
        },
        enumerable: true,
        configurable: true
    });
     ...
     * @hidden
     */
    HierarchyBindingDirective.prototype.handleFilterChange = function (term) {
        if (!this.filterData) {
            return;
        }
        var filteredNodes = term ? filterTree(this.filterData, term, this.filterSettings, this.treeView.textField) : this.filterData;
        this.visibleNodes.clear();
        this.updateNodesVisibility(filteredNodes);
    };
    HierarchyBindingDirective.prototype.updateNodesVisibility = function (items) {
        var _this = this;
