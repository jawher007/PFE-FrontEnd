...
var mapToTree = function (currentLevelNodes, allNodes, parentIdField, idField) {
    ...
    return currentLevelNodes.map(function (node) { return ({
        dataItem: node,
        children: mapToTree(findChildren(kendo_common_1.getter(parentIdField), allNodes || [], kendo_common_1.getter(idField)(node)), allNodes, parentIdField, idField)
    }); });
};
var ɵ1 = mapToTree;
exports.ɵ1 = ɵ1;
...
var FlatDataBindingDirective = /** @class */ (function () {
    function FlatDataBindingDirective(treeView) {
        ...
        this._filterSettings = treeview_filter_settings_1.defaultTreeviewFilterSettings;
    ...
    Object.defineProperty(FlatDataBindingDirective.prototype, "filterSettings", {
         ...
         */
        set: function (value) {
            this._filterSettings = tslib_1.__assign({}, treeview_filter_settings_1.defaultTreeviewFilterSettings, value);
        },
        enumerable: true,
        configurable: true
    });
    ...
    FlatDataBindingDirective.prototype.handleFilterChange = function (term) {
        ...
        var filteredData = term
            ? utils_1.filterTree(this.filterData, term, this.filterSettings, this.treeView.textField)
            : this.filterData;
        this.visibleNodes.clear();
