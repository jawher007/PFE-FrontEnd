...
import { EventEmitter, Input, Output, ViewChild, ElementRef, HostBinding, Component, Renderer2, Directive, TemplateRef, Injectable, ViewChildren, QueryList, ChangeDetectorRef, NgZone, forwardRef, isDevMode, ContentChild, ViewContainerRef, InjectionToken, Optional, Inject, KeyValueDiffers, ContentChildren, ChangeDetectionStrategy, NgModule, HostListener } from '@angular/core';
 ...
 * @hidden
 */
const getter$1 = (dataItem, field, usePrimitive = false) => {
...
HeaderTemplateDirective = __decorate([
    Directive({
        selector: '[kendoDropDownListHeaderTemplate],[kendoComboBoxHeaderTemplate],[kendoDropDownTreeHeaderTemplate],[kendoMultiColumnComboBoxHeaderTemplate],[kendoAutoCompleteHeaderTemplate],[kendoMultiSelectHeaderTemplate]'
    }),
    __metadata("design:paramtypes", [TemplateRef])
...
FooterTemplateDirective = __decorate([
    Directive({
        selector: '[kendoDropDownListFooterTemplate],[kendoComboBoxFooterTemplate],[kendoDropDownTreeFooterTemplate],[kendoMultiColumnComboBoxFooterTemplate],[kendoAutoCompleteFooterTemplate],[kendoMultiSelectFooterTemplate]'
    }),
    __metadata("design:paramtypes", [TemplateRef])
...
NoDataTemplateDirective = __decorate([
    Directive({
        selector: '[kendoDropDownListNoDataTemplate],[kendoDropDownTreeNoDataTemplate],[kendoComboBoxNoDataTemplate],[kendoMultiColumnComboBoxNoDataTemplate],[kendoAutoCompleteNoDataTemplate],[kendoMultiSelectNoDataTemplate]'
    }),
    __metadata("design:paramtypes", [TemplateRef])
...
let ListComponent = class ListComponent {
    ...
    hasScrollbar() {
        ...
        // in virtual mode a scrollbar is rendered even if there's just one item
        return isPresent(this.virtual) || this.list.nativeElement.scrollHeight > this.content.nativeElement.offsetHeight;
    }
    positionItems() {
...
let AutoCompleteComponent = AutoCompleteComponent_1 = class AutoCompleteComponent {
    ...
    handleEnter(event) {
        ...
        if (focused >= 0) {
            ...
            const match = this.suggest && this.suggestedText && this.data.length &&
                getter$1(this.dataService.itemAt(0), this.valueField, true).toLowerCase() === this.searchbar.value.toLowerCase();
    ...
    handleBlur() {
        ...
        if (focused !== -1) {
            ...
            text = getter$1(dataItem, this.valueField, true) || "";
        }
        else {
...
let ComboBoxComponent = ComboBoxComponent_1 = class ComboBoxComponent {
     ...
     */
    set virtual(settings) {
        this._virtualSettings = normalizeVirtualizationSettings(settings, { itemHeight: this.defaultItemHeight });
    }
    get virtual() {
        return this._virtualSettings;
    }
    ...
    handleEnter() {
        ...
        const previousText = getter$1(this._previousDataItem, this.textField, this.valuePrimitive) || "";
...
NodeTemplateDirective = __decorate([
    Directive({
        selector: '[kendoDropDownTreeNodeTemplate]'
    }),
    __metadata("design:paramtypes", [TemplateRef])
...
let DropDownTreeComponent = DropDownTreeComponent_1 = class DropDownTreeComponent {
    constructor(popupService, navigationService, renderer, hostElement, _zone, cdr, localization) {
        this.popupService = popupService;
        this.navigationService = navigationService;
        this.renderer = renderer;
        this.hostElement = hostElement;
    ...
    setState() {
        if (isPresent(this.dataItem) && isPresent(this.valueField)) {
    ...
    subscribeEvents() {
        this.subscriptions.push(this.navigationService.open.subscribe(() => this.togglePopup(true)), this.navigationService.close.subscribe(() => {
            ...
            .subscribe(() => this.handleEscape()), this.navigationService.tab.subscribe(() => this.focus()));
    }
    unsubscribeEvents() {
 ...
 */
let DropDownTreesFlatBindingDirective = class DropDownTreesFlatBindingDirective extends FlatDataBindingDirective {
...
__decorate([
    ...
    __metadata("design:type", Array)
], DropDownTreesFlatBindingDirective.prototype, "nodes", void 0);
__decorate([
    Input('valueField'),
    __metadata("design:type", String)
], DropDownTreesFlatBindingDirective.prototype, "idField", void 0);
DropDownTreesFlatBindingDirective = __decorate([
    Directive({
        selector: '[kendoDropDownTreeFlatBinding]'
    }),
    __metadata("design:paramtypes", [DataBoundComponent])
], DropDownTreesFlatBindingDirective);

/**
 * A directive which encapsulates the retrieval of the child nodes when hierarchical data is provided.
 */
let DropDownTreesHierarchyBindingDirective = class DropDownTreesHierarchyBindingDirective extends HierarchyBindingDirective {
    constructor(dropDownTree) {
        super(dropDownTree);
...
__decorate([
    ...
    __metadata("design:type", Array),
    __metadata("design:paramtypes", [Array])
], DropDownTreesHierarchyBindingDirective.prototype, "data", null);
DropDownTreesHierarchyBindingDirective = __decorate([
    Directive({
        selector: '[kendoDropDownTreeHierarchyBinding]'
    }),
    __metadata("design:paramtypes", [DataBoundComponent])
], DropDownTreesHierarchyBindingDirective);
...
CustomMessagesComponent = CustomMessagesComponent_1 = __decorate([
    Component({
        ...
        selector: 'kendo-dropdownlist-messages,kendo-combobox-messages,kendo-multicolumncombobox-messages,kendo-autocomplete-messages,kendo-multiselect-messages,kendo-dropdowntree-messages',
        template: ``
    }),
    __metadata("design:paramtypes", [LocalizationService])
...
let FilterDirective = class FilterDirective {
    ...
    set filterSettings(settings) {
        this._filterSettings = Object.assign({}, DEFAULT_FILTER_SETTINGS, settings, { fields: this.getFilterFields(settings.fields) });
    }
    get filterSettings() {
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [Object])
], FilterDirective.prototype, "filterSettings", null);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
...
MultiSelectModule = __decorate([
    NgModule({
        ...
        imports: [SharedModule],
        providers: [{ provide: TOUCH_ENABLED, useValue: ɵ0$3 }]
    })
], MultiSelectModule);
...
export { AUTOCOMPLETE_VALUE_ACCESSOR, COMBOBOX_VALUE_ACCESSOR, TOUCH_ENABLED, DataService, DisabledItemsService, FilterableComponent, ListItemDirective, CustomMessagesComponent, LocalizedMessagesDirective, Messages, NavigationService, SearchBarComponent, SelectionService, NoDataTemplateDirective, TagTemplateDirective, DROPDOWNLIST_VALUE_ACCESSOR, FilterInputDirective, AutoCompleteComponent, ComboBoxComponent, DropDownListComponent, MultiSelectComponent, TagListComponent, MultiColumnComboBoxComponent, ComboBoxColumnComponent, ColumnCellTemplateDirective, ColumnHeaderTemplateDirective, DropDownTreeComponent, DropDownTreesFlatBindingDirective, DropDownTreesHierarchyBindingDirective, DropDownTreesExpandDirective, DropDownTreesModule, NodeTemplateDirective, ItemTemplateDirective, GroupTemplateDirective, FixedGroupTemplateDirective, CustomItemTemplateDirective, HeaderTemplateDirective, FooterTemplateDirective, ValueTemplateDirective, TemplateContextDirective, GroupTagTemplateDirective, SelectableDirective, SummaryTagDirective, FilterDirective, DropDownsModule, MultiSelectModule, SharedModule, AutoCompleteModule, ComboBoxModule, DropDownListModule, SharedDirectivesModule, ListComponent, PreventableEvent };
