...
var ComboBoxComponent = /** @class */ (function () {
    function ComboBoxComponent(localization, popupService, selectionService, navigationService, disabledItemsService, dataService, zone, cdr, renderer, hostElement, touchEnabled) {
    ...
    Object.defineProperty(ComboBoxComponent.prototype, "virtual", {
         ...
         */
        set: function (settings) {
            this._virtualSettings = virtualization_settings_1.normalizeVirtualizationSettings(settings, { itemHeight: this.defaultItemHeight });
        },
        enumerable: true,
        configurable: true
    });
    ...
    tslib_1.__decorate([
        core_1.HostBinding('class.k-combobox-clearable'),
        tslib_1.__metadata("design:type", Boolean),
    ...
    ComboBoxComponent = ComboBoxComponent_1 = tslib_1.__decorate([
        core_1.Component({
            ...
            providers: [
                ...
                {
                    provide: filterable_component_1.FilterableComponent, useExisting: core_1.forwardRef(function () { return ComboBoxComponent_1; })
                },
                {
                    provide: kendo_angular_common_1.KendoInput, useExisting: core_1.forwardRef(function () { return ComboBoxComponent_1; })
                }
            ],
        ...
        tslib_1.__param(10, core_1.Optional()), tslib_1.__param(10, core_1.Inject(touch_enabled_1.TOUCH_ENABLED)),
