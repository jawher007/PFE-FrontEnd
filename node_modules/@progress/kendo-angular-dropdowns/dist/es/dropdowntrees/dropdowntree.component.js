...
import { ChangeDetectionStrategy, Component, ElementRef, EventEmitter, HostBinding, Input, Output, NgZone, Renderer2, TemplateRef, ViewChild, ChangeDetectorRef, ContentChild, forwardRef, ViewContainerRef, isDevMode } from '@angular/core';
...
import { isArray, isPresent, isUntouched, noop } from '../common/util';
...
var DropDownTreeComponent = /** @class */ (function () {
    function DropDownTreeComponent(popupService, navigationService, renderer, hostElement, _zone, cdr, localization) {
         ...
         */
        this.fetchChildren = function () { return of([]); };
        /**
         ...
         */
        this.itemDisabled = function () { return false; };
        /**
         * @hidden
         *
    ...
    DropDownTreeComponent.prototype.subscribeEvents = function () {
        ...
        this.subscriptions.push(this.navigationService.open.subscribe(function () { return _this.togglePopup(true); }), this.navigationService.close.subscribe(function () {
            ...
            .subscribe(function () { return _this.handleEscape(); }), this.navigationService.tab.subscribe(function () { return _this.focus(); }));
    };
