...
var limit = function (borderValue) { return function (barrier, value) {
    ...
    return useBarrier ? barrier : util_1.setMilliseconds(barrier, borderValue);
}; };
var ɵ3 = limit;
exports.ɵ3 = ɵ3;
...
var MillisecondsService = /** @class */ (function () {
    ...
    MillisecondsService.prototype.apply = function (value, candidate) {
        return util_1.setMilliseconds(value, candidate.getMilliseconds());
    };
    MillisecondsService.prototype.configure = function (settings) {
        ...
        this.toListItem = function (millisecond) {
            var date = util_1.setMilliseconds(defaults_1.MIDNIGHT_DATE, millisecond);
            return {
    ...
    MillisecondsService.prototype.isLastMissing = function (value) {
        return this.isMissing(util_1.setMilliseconds(this.max, this.lastMillisecond(value)));
    };
...
exports.MillisecondsService = MillisecondsService;
