...
var TimeSelectorCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    TimeSelectorCustomMessagesComponent = TimeSelectorCustomMessagesComponent_1 = tslib_1.__decorate([
        core_1.Component({
            providers: [
                {
                    provide: messages_1.TimePickerMessages,
                    useExisting: core_1.forwardRef(function () { return TimeSelectorCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
