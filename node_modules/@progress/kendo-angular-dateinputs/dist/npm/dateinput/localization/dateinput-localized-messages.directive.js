...
var DateInputLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    DateInputLocalizedMessagesDirective = DateInputLocalizedMessagesDirective_1 = tslib_1.__decorate([
        core_1.Directive({
            providers: [
                {
                    provide: messages_1.DateInputMessages,
                    useExisting: core_1.forwardRef(function () { return DateInputLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
