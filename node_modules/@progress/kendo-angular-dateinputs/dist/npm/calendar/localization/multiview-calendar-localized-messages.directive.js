...
var MultiViewCalendarLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    MultiViewCalendarLocalizedMessagesDirective = MultiViewCalendarLocalizedMessagesDirective_1 = tslib_1.__decorate([
        core_1.Directive({
            providers: [
                {
                    provide: multiview_calendar_messages_1.Messages,
                    useExisting: core_1.forwardRef(function () { return MultiViewCalendarLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
