...
var CenturyViewService = /** @class */ (function () {
    ...
    CenturyViewService.prototype.data = function (options) {
        ...
        var cells = util_1.range(0, cellsLength);
        ...
        return util_1.range(0, rowsLength).map(function (rowOffset) {
            var baseDate = kendo_date_math_1.addDecades(firstDate, rowOffset * cellsLength);
