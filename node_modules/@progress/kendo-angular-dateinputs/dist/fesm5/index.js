...
import { Injectable, Injector, EventEmitter, InjectionToken, Input, Output, HostBinding, Component, Inject, ElementRef, Renderer2, NgZone, TemplateRef, ViewChild, ChangeDetectionStrategy, ChangeDetectorRef, Directive, isDevMode, forwardRef, ContentChild, Optional, ViewContainerRef, HostListener, ViewChildren, QueryList, ContentChildren, IterableDiffers, NgModule } from '@angular/core';
 ...
 * @hidden
 */
var setYears = setter('setFullYear');
/**
 * @hidden
 */
 ...
 */
var msPaddingFromFormat = function (format) {
...
var _a;
var EMPTY_DATA = [[]];
var VERTICAL_VIEW_CELLS_LENGTH = 5;
var HORIZONTAL_VIEW_CELLS_LENGTH = 4;
var VERTICAL_VIEW_ROWS_LENGTH = 2;
var HORIZONTAL_VIEW_ROWS_LENGTH = 3;
var ACTIONS = (_a = {},
...
var CenturyViewService = /** @class */ (function () {
    ...
    CenturyViewService.prototype.data = function (options) {
        var _this = this;
        var cellUID = options.cellUID, focusedDate = options.focusedDate, isActiveView = options.isActiveView, max = options.max, min = options.min, selectedDate = options.selectedDate, _a = options.selectionRange, selectionRange = _a === void 0 ? EMPTY_SELECTIONRANGE : _a, viewDate = options.viewDate, direction = options.direction;
        if (!viewDate) {
            return EMPTY_DATA;
        }
        var cellsLength = this.rowLength({ direction: direction });
        var rowsLength = direction === 'horizontal' ? HORIZONTAL_VIEW_ROWS_LENGTH : VERTICAL_VIEW_ROWS_LENGTH;
        var cells = range(0, cellsLength);
        ...
        var today = getToday();
        return range(0, rowsLength).map(function (rowOffset) {
            var baseDate = addDecades(firstDate, rowOffset * cellsLength);
    ...
    CenturyViewService.prototype.rowLength = function (options) {
        if (options === void 0) { options = {}; }
        return options.direction === 'horizontal' ? HORIZONTAL_VIEW_CELLS_LENGTH : VERTICAL_VIEW_CELLS_LENGTH;
    };
...
var _a$1;
var EMPTY_DATA$1 = [[]];
var VERTICAL_VIEW_CELLS_LENGTH$1 = 5;
var HORIZONTAL_VIEW_CELLS_LENGTH$1 = 4;
var VERTICAL_VIEW_ROWS_LENGTH$1 = 2;
var HORIZONTAL_VIEW_ROWS_LENGTH$1 = 3;
var ACTIONS$1 = (_a$1 = {},
...
var DecadeViewService = /** @class */ (function () {
    ...
    DecadeViewService.prototype.data = function (options) {
        ...
        var cellsLength = this.rowLength({ direction: direction });
        var rowsLength = direction === 'horizontal' ? HORIZONTAL_VIEW_ROWS_LENGTH$1 : VERTICAL_VIEW_ROWS_LENGTH$1;
        var cells = range(0, cellsLength);
        ...
        var today = getToday();
        return range(0, rowsLength).map(function (rowOffset) {
            var baseDate = addYears(firstDate, rowOffset * cellsLength);
            return cells.map(function (cellOffset) {
    ...
    DecadeViewService.prototype.rowLength = function (options) {
        if (options === void 0) { options = {}; }
        return options.direction === 'horizontal' ? HORIZONTAL_VIEW_CELLS_LENGTH$1 : VERTICAL_VIEW_CELLS_LENGTH$1;
    };
...
var _a$3;
var EMPTY_DATA$3 = [[]];
var VERTICAL_VIEW_CELLS_LENGTH$2 = 5;
var HORIZONTAL_VIEW_CELLS_LENGTH$2 = 4;
var ROWS_LENGTH$1 = 3;
...
var YearViewService = /** @class */ (function () {
    ...
    YearViewService.prototype.data = function (options) {
        ...
        return range(0, ROWS_LENGTH$1).map(function (rowOffset) {
            var baseDate = addMonths(firstDate, rowOffset * cellsLength);
            return cells.map(function (cellOffset) {
    ...
    YearViewService.prototype.rowLength = function (options) {
        if (options === void 0) { options = {}; }
        return options.direction === 'horizontal' ? HORIZONTAL_VIEW_CELLS_LENGTH$2 : VERTICAL_VIEW_CELLS_LENGTH$2;
    };
...
var VirtualizationComponent = /** @class */ (function () {
    ...
    VirtualizationComponent = __decorate([
        Component({
            providers: [{
...
var ViewListComponent = /** @class */ (function () {
    ...
    ViewListComponent.prototype.ngOnChanges = function (changes) {
        ...
        this.cols = new Array(this.service.rowLength({ prependCell: this.weekNumber, direction: 'vertical' })).fill('');
    ...
    __decorate([
        Input(),
        __metadata("design:type", Date)
    ], ViewListComponent.prototype, "value", void 0);
    __decorate([
        Input(),
        __metadata("design:type", Boolean),
    ...
    __decorate([
        Output(),
        __metadata("design:type", EventEmitter)
    ], ViewListComponent.prototype, "valueChange", void 0);
    __decorate([
        Output(),
        __metadata("design:type", EventEmitter)
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean),
        __metadata("design:paramtypes", [])
    ], ViewListComponent.prototype, "getComponentClass", null);
    __decorate([
...
var ScrollSyncService = /** @class */ (function () {
    ...
    ScrollSyncService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [CalendarDOMService, NgZone])
    ], ScrollSyncService);
...
var MonthCellTemplateDirective = /** @class */ (function () {
    ...
    MonthCellTemplateDirective = __decorate([
        Directive({
...
var YearCellTemplateDirective = /** @class */ (function () {
    ...
    YearCellTemplateDirective = __decorate([
        Directive({
...
var DecadeCellTemplateDirective = /** @class */ (function () {
    ...
    DecadeCellTemplateDirective = __decorate([
        Directive({
...
var CenturyCellTemplateDirective = /** @class */ (function () {
    ...
    CenturyCellTemplateDirective = __decorate([
        Directive({
...
var WeekNumberCellTemplateDirective = /** @class */ (function () {
    ...
    WeekNumberCellTemplateDirective = __decorate([
        Directive({
...
var HeaderTitleTemplateDirective = /** @class */ (function () {
    ...
    HeaderTitleTemplateDirective = __decorate([
        Directive({
...
var NavigationItemTemplateDirective = /** @class */ (function () {
    ...
    NavigationItemTemplateDirective = __decorate([
        Directive({
...
var DisabledDatesService = /** @class */ (function () {
    ...
    DisabledDatesService = __decorate([
        Injectable()
...
var CalendarComponent = /** @class */ (function () {
    function CalendarComponent(bus, dom, element, navigator, renderer, cdr, ngZone, injector, scrollSyncService, disabledDatesService, localization, pickerService) {
        this.bus = bus;
        this.dom = dom;
...
var HorizontalViewListComponent = /** @class */ (function () {
    ...
    HorizontalViewListComponent = __decorate([
        Component({
            changeDetection: ChangeDetectionStrategy.OnPush,
...
var MultiViewCalendarComponent = /** @class */ (function () {
    function MultiViewCalendarComponent(bus, element, navigator, renderer, cdr, zone, disabledDatesService) {
        this.bus = bus;
        this.element = element;
        this.navigator = navigator;
        this.renderer = renderer;
    ...
    MultiViewCalendarComponent.prototype.handleDateChange = function (candidate) {
        var canNavigateDown = this.bus.canMoveDown(this.activeViewEnum);
        var isSameDate = !canNavigateDown && isEqual(candidate, this.value);
        this.setActiveDate(cloneDate(candidate));
        this.focusedDate = cloneDate(candidate) || this.focusedDate;
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], MultiViewCalendarComponent.prototype, "enter", null);
    MultiViewCalendarComponent = __decorate([
        Component({
            changeDetection: ChangeDetectionStrategy.OnPush,
...
var DateRangePopupTemplateDirective = /** @class */ (function () {
    ...
    DateRangePopupTemplateDirective = __decorate([
        Directive({
...
var DateRangePopupComponent = /** @class */ (function () {
    ...
    DateRangePopupComponent = __decorate([
        Component({
            exportAs: 'kendo-daterange-popup',
            selector: 'kendo-daterange-popup',
            template: "\n        <ng-container #container></ng-container>\n        <ng-template #defaultTemplate>\n            <kendo-multiviewcalendar kendoDateRangeSelection></kendo-multiviewcalendar>\n        </ng-template>\n    "
        }),
        __param(4, Optional()), __param(4, Inject(RTL)),
        __metadata("design:paramtypes", [PopupService,
            DateRangeService,
            ChangeDetectorRef,
            NgZone, Boolean])
...
var DateRangeEndInputDirective = /** @class */ (function (_super) {
    ...
    DateRangeEndInputDirective = __decorate([
        Directive({
...
var DateRangeStartInputDirective = /** @class */ (function (_super) {
    ...
    DateRangeStartInputDirective = __decorate([
        Directive({
...
var DateRangeSelectionDirective = /** @class */ (function () {
    ...
    DateRangeSelectionDirective = __decorate([
        Directive({
...
var KForOf = /** @class */ (function () {
    ...
    KForOf = __decorate([
        Directive({ selector: '[kFor][kForOf]' }),
...
var ViewComponent = /** @class */ (function () {
    ...
    ViewComponent.prototype.ngOnChanges = function (changes) {
        ...
        this.colSpan = this.service.rowLength({ prependCell: this.weekNumber, direction: this.direction });
...
var CalendarCommonModule = /** @class */ (function () {
    ...
    CalendarCommonModule = __decorate([
        NgModule({
            declarations: [
                KForOf,
                HeaderComponent,
...
var MultiViewCalendarLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    MultiViewCalendarLocalizedMessagesDirective_1 = MultiViewCalendarLocalizedMessagesDirective;
    var MultiViewCalendarLocalizedMessagesDirective_1;
    MultiViewCalendarLocalizedMessagesDirective = MultiViewCalendarLocalizedMessagesDirective_1 = __decorate([
        Directive({
            providers: [
                {
                    provide: Messages,
                    useExisting: forwardRef(function () { return MultiViewCalendarLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var MultiViewCalendarCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    MultiViewCalendarCustomMessagesComponent_1 = MultiViewCalendarCustomMessagesComponent;
    ...
    MultiViewCalendarCustomMessagesComponent = MultiViewCalendarCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: Messages,
                    useExisting: forwardRef(function () { return MultiViewCalendarCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var MultiViewCalendarModule = /** @class */ (function () {
    ...
    MultiViewCalendarModule = __decorate([
        NgModule({
            declarations: [
                HorizontalViewListComponent,
                MultiViewCalendarLocalizedMessagesDirective,
...
var CalendarLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    CalendarLocalizedMessagesDirective = CalendarLocalizedMessagesDirective_1 = __decorate([
        Directive({
            providers: [
                {
                    provide: CalendarMessages,
                    useExisting: forwardRef(function () { return CalendarLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var CalendarCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    CalendarCustomMessagesComponent = CalendarCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: CalendarMessages,
                    useExisting: forwardRef(function () { return CalendarCustomMessagesComponent_1; })
                }
            ],
...
var VirtualizationModule = /** @class */ (function () {
    ...
    VirtualizationModule = __decorate([
        NgModule({
...
var DateInputLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    DateInputLocalizedMessagesDirective_1 = DateInputLocalizedMessagesDirective;
    var DateInputLocalizedMessagesDirective_1;
    DateInputLocalizedMessagesDirective = DateInputLocalizedMessagesDirective_1 = __decorate([
        Directive({
            providers: [
                {
                    provide: DateInputMessages,
                    useExisting: forwardRef(function () { return DateInputLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var DateInputCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    DateInputCustomMessagesComponent_1 = DateInputCustomMessagesComponent;
    ...
    DateInputCustomMessagesComponent = DateInputCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: DateInputMessages,
                    useExisting: forwardRef(function () { return DateInputCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var DatePickerLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    DatePickerLocalizedMessagesDirective = DatePickerLocalizedMessagesDirective_1 = __decorate([
        Directive({
            providers: [
                {
                    provide: DatePickerMessages,
                    useExisting: forwardRef(function () { return DatePickerLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var DatePickerCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    DatePickerCustomMessagesComponent_1 = DatePickerCustomMessagesComponent;
    ...
    DatePickerCustomMessagesComponent = DatePickerCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: DatePickerMessages,
                    useExisting: forwardRef(function () { return DatePickerCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var TimePickerDOMService = /** @class */ (function () {
    ...
    TimePickerDOMService = __decorate([
        Injectable()
...
var SecondsService = /** @class */ (function () {
    ...
    SecondsService.prototype.configure = function (settings) {
        ...
        this.toListItem = function (second) {
            var date = setSeconds(MIDNIGHT_DATE, second);
            return {
                text: _this.intl.formatDate(date, part.pattern),
                value: date
            };
...
var clampToRange$3 = function (rangeValue) { return function (value) { return value % rangeValue; }; };
var clamp$3 = clampToRange$3(MILLISECONDS_IN_SECOND);
var stepper$3 = function (start, step) { return function (idx) { return clamp$3(start + (idx * step)); }; };
var distanceFromMin$3 = function (value, min) { return clamp$3(MILLISECONDS_IN_SECOND + value - min); };
var limit$3 = function (borderValue) { return function (barrier, value) {
...
var limitUp$3 = limit$3(MILLISECONDS_IN_SECOND - 1);
/**
 * @hidden
 */
var MillisecondsService = /** @class */ (function () {
    ...
    MillisecondsService.prototype.data = function (selectedValue) {
        var _this = this;
        var min = this.range(selectedValue)[0];
        var getMillisecond = stepper$3(min, this.step);
    ...
    MillisecondsService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [IntlService])
    ], MillisecondsService);
...
var services$1 = (_a$6 = {},
    ...
    _a$6[TIME_PART.millisecond] = MillisecondsService,
    _a$6);
/**
 * @hidden
 */
...
var TimePickerLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    TimePickerLocalizedMessagesDirective_1 = TimePickerLocalizedMessagesDirective;
    var TimePickerLocalizedMessagesDirective_1;
    TimePickerLocalizedMessagesDirective = TimePickerLocalizedMessagesDirective_1 = __decorate([
        Directive({
            providers: [
                {
                    provide: TimePickerMessages,
                    useExisting: forwardRef(function () { return TimePickerLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var TimePickerCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    TimePickerCustomMessagesComponent = TimePickerCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: TimePickerMessages,
                    useExisting: forwardRef(function () { return TimePickerCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var TimeSelectorLocalizedMessagesDirective = /** @class */ (function (_super) {
    ...
    TimeSelectorLocalizedMessagesDirective_1 = TimeSelectorLocalizedMessagesDirective;
    var TimeSelectorLocalizedMessagesDirective_1;
    TimeSelectorLocalizedMessagesDirective = TimeSelectorLocalizedMessagesDirective_1 = __decorate([
        Directive({
            providers: [
                {
                    provide: TimePickerMessages,
                    useExisting: forwardRef(function () { return TimeSelectorLocalizedMessagesDirective_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var TimeSelectorCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    TimeSelectorCustomMessagesComponent_1 = TimeSelectorCustomMessagesComponent;
    ...
    TimeSelectorCustomMessagesComponent = TimeSelectorCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: TimePickerMessages,
                    useExisting: forwardRef(function () { return TimeSelectorCustomMessagesComponent_1; }) // tslint:disable-line:no-forward-ref
                }
            ],
...
var Messages$1 = /** @class */ (function (_super) {
    ...
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "toggle", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "dateTab", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "dateTabLabel", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "timeTab", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "timeTabLabel", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "accept", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "acceptLabel", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ...
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "cancelLabel", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "today", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "now", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "nowLabel", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
    ], Messages.prototype, "prevButtonTitle", void 0);
...
var DateTimePickerCustomMessagesComponent = /** @class */ (function (_super) {
    ...
    DateTimePickerCustomMessagesComponent_1 = DateTimePickerCustomMessagesComponent;
    ...
    DateTimePickerCustomMessagesComponent = DateTimePickerCustomMessagesComponent_1 = __decorate([
        Component({
            providers: [
                {
                    provide: Messages$1,
                    useExisting: forwardRef(function () { return DateTimePickerCustomMessagesComponent_1; })
                }
            ],
