 ...
 * @hidden
 */
var isUploadComponent = function (component) { return component.wrapper && (component.wrapper.tagName === 'KENDO-UPLOAD' || component.wrapper.tagName === 'KENDO-FILESELECT'); };
/**
 * @hidden
 */
var isInputElement = function (component) { return component instanceof HTMLElement; };
/**
 * @hidden
 */
var inputElementHasAttr = function (element, attribute) { return element.hasAttribute(attribute); };
/**
 * @hidden
 */
var getWrappedNativeInput = function (element) { return element.querySelector('kendo-label > input, kendo-label > textarea, kendo-label > select'); };
/**
 * @hidden
 */
...
var LabelDirective = /** @class */ (function () {
    ...
    LabelDirective.prototype.getFocusableComponent = function () {
        var target = this.for;
        return target.focus !== undefined ? target : null;
    };
    __decorate([
        Input(),
