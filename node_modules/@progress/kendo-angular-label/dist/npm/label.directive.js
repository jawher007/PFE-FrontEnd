...
var LabelDirective = /** @class */ (function () {
    ...
    Object.defineProperty(LabelDirective.prototype, "labelFor", {
        get: function () {
            ...
            if (util_1.isInputElement(component) && !util_1.inputElementHasAttr(component, 'id')) {
                this.renderer.setAttribute(component, 'id', "k-" + kendo_angular_common_1.guid());
            }
    ...
    LabelDirective = tslib_1.__decorate([
        ...
        tslib_1.__metadata("design:paramtypes", [core_1.ElementRef, core_1.Renderer2, core_1.NgZone])
    ], LabelDirective);
