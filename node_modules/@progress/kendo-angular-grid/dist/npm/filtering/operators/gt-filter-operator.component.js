...
var GreaterFilterOperatorComponent = /** @class */ (function (_super) {
    ...
    GreaterFilterOperatorComponent = GreaterFilterOperatorComponent_1 = tslib_1.__decorate([
        core_1.Component({
            providers: [
                {
                    provide: filter_operator_base_1.FilterOperatorBase,
                    useExisting: core_1.forwardRef(function () { return GreaterFilterOperatorComponent_1; })
                }
            ],
