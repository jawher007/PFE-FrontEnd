...
var BeforeEqFilterOperatorComponent = /** @class */ (function (_super) {
    ...
    BeforeEqFilterOperatorComponent = BeforeEqFilterOperatorComponent_1 = tslib_1.__decorate([
        core_1.Component({
            providers: [
                {
                    provide: filter_operator_base_1.FilterOperatorBase,
                    useExisting: core_1.forwardRef(function () { return BeforeEqFilterOperatorComponent_1; })
                }
            ],
