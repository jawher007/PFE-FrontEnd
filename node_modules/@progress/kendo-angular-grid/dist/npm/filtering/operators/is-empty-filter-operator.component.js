...
var IsEmptyFilterOperatorComponent = /** @class */ (function (_super) {
    ...
    IsEmptyFilterOperatorComponent = IsEmptyFilterOperatorComponent_1 = tslib_1.__decorate([
        core_1.Component({
            providers: [
                {
                    provide: filter_operator_base_1.FilterOperatorBase,
                    useExisting: core_1.forwardRef(function () { return IsEmptyFilterOperatorComponent_1; })
                }
            ],
